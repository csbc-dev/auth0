...
/**
 * Refcount of `<auth0-gate>` instances (and any direct callers) that
 ...
 * and unmounts `<auth0-gate>` (routing, dynamic toolbars, etc.) tear
...
function handleClick(event: Event): void {
  ...
  // via `authEl.error` / `auth0-gate:error`, matching the trigger
